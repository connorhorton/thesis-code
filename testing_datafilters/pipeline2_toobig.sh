...
echo "pairsamtools!" 
pairsamtools parse -c helper_files/$GENOME.chrom.sizes.mainonly --assembly $GENOME --max-molecule-size 50000 \
	--output-stats $DIR/${FASTQ_ROOT}_stats.txt $DIR/${FASTQ_ROOT}_raw.sam | {
